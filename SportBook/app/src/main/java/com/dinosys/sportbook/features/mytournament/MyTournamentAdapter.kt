...
class MyTournamentAdapter(val myTournaments: List<TournamentDataModel>?, val myTournamentRef: WeakReference<OnTournamentListener>) : RecyclerView.Adapter<MyTournamentViewHolder>() {
    ...
    override fun onBindViewHolder(holder: MyTournamentViewHolder, position: Int) {
        holder.bindView(myTournaments!![position], position, myTournamentRef)
    }
