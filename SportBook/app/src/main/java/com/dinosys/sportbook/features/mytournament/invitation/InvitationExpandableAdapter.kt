...
class InvitationExpandableAdapter(val context: Context, private val expandableListTitle: Array<String>, val expandableListDetail: HashMap<String, Array<String>>): BaseExpandableListAdapter() {
    ...
    override fun getChildView(listPosition: Int, expandedListPosition: Int,
        ...
        if (convertView == null) {
            convertView = LayoutInflater.from(context).inflate(R.layout.item_invitation_item, null)
        }
    ...
    override fun getGroupView(listPosition: Int, isExpanded: Boolean,
        ...
        if (convertView == null) {
            convertView = LayoutInflater.from(context).inflate(R.layout.item_invitation_header, null)
        }
